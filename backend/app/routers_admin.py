...
def get_table_records(
    ...
    if has_id:
        ...
        query = text(f"SELECT * FROM {table_name} ORDER BY {first_col} LIMIT :limit OFFSET :offset")
        ...
        for record in raw_records:
            ...
            for key, value in record.items():
                if isinstance(value, bytes):
                    ...
                    try:
                        processed_record[key] = str(value) if not isinstance(value, (dict, list)) else value
                    except:
